...
- **Interactive HTML** — Type your own notes directly into the recipes. Save your custom ratios. Your entries stay on your device (no account, no cloud). Note: clearing browser data clears your entries.
- **Printable PDF** — Print and fill by hand. Print as many copies as you want.
...
- homekeeping-guide-interactive.html (interactive — type and save)
- homekeeping-guide.pdf (printable — write by hand)
